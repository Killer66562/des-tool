...
pub fn s_box(input: u64) -> u32 {
    ...
    for box_idx in 0..8 {
        let shift = 42 - box_idx * 6;
        let chunk = ((input >> shift) & 0x3F) as u8;
        let row = (((chunk & 0b100000) >> 4) | (chunk & 0b000001)) as usize;
        let col = ((chunk >> 1) & 0b1111) as usize;
        let value = S_BOXES[box_idx][row][col] as u32;
